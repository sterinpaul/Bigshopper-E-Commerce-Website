...
// Index no increment function
Handlebars.registerHelper("inc", function(value, options){
  return parseInt(value) + 1;
});

// If condition Helper
Handlebars.registerHelper('ifvalue', function(v1, v2, options) {
  if(v1 == v2) {
...
Handlebars.registerHelper("multiply", function(thing1, thing2) {
  return Math.round(thing1 * thing2*100)/100
});
